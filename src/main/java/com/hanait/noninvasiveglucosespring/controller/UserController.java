...
//        }
    ...
    public Optional<User> infoUser(@RequestHeader("Authorization") String token, HttpServletRequest request,
        ...
        Map<String, Object> infoUserData = mapper.readValue(payload, Map.class);

        Long id = Long.parseLong(String.valueOf(infoUserData.get("id")));

        Optional<User> infoUser = userRepository.findById(id);
